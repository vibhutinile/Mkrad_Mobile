...
import {getAdminPauseList, requestGetApi} from '../../NetworkCall/Service';
import {getAsyncStorage} from '../../Routes/AsynstorageClass';

let jobList = [];
let jobid = '';
let jobDate = '';
class AdminPauseJob extends React.Component {
  constructor() {
    super();
    this.state = {
      customerJobList: [],
  ...
  // onGoingScreen = (customerName, address1, address2,
  //     phoneNo, serviceName, startTime, endTime,
  //     jobId, job_date, city, state, zipcode) => {
                ...
                <View style={{marginLeft: 20}}>
                  ...
                  <Text style={styles.TextContainer_6}>
                    {item.job_scheduler_details.start_time +
                      ' to ' +
                      item.job_scheduler_details.end_time}
                  </Text>
                  <this.Separator />
  ...
  //         this.onGoingScreen(item.customer.name, item.customer.address_line_1,
  //             item.customer.address_line_2, item.customer.phone, item.service.name,
