...
class LoginPage extends React.Component {
  constructor() {
    super();
    this.state = {
      // userEmail: 'Tushartest@yopmail.com',
      // userPassword: '123456',
      userEmail: '',
      userPassword: '',
  ...
  handleSubmitPress = async () => {
    ...
    if (responseJson.status) {
      ...
      await setAsyncStorage('token', responseJson.access_token);
  ...
  sendOtp = async () => {
    ...
    if (responseJson.status) {
      ...
      //Alert.alert("otp send on your email!");
    } else {
        ...
        <ScrollView
          ...
          <View style={styles.AdminButtonStyle}>
            {/* <TouchableOpacity
                        ...
                        <Text style={styles.TextStyle}> Administrator Logins </Text>
                    </TouchableOpacity> */}
          </View>
