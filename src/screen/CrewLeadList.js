...
import {crew_lead_name_list, requestGetApi} from '../NetworkCall/Service';
...
class CrewLeadList extends React.Component {
  constructor() {
    super();
  ...
  crewMemberLogs = (id) => {
    this.props.navigation.navigate('AdminCrewAttendanceLog', {
      id: id,
    });
  };
