...
class CrewLeadAttendanceLog extends React.Component {
  constructor() {
    super();
  ...
  get_crewLeadLogs = async () => {
    ...
    if (responseJson.status) {
      ...
      if (this.state.PageNo == 1) {
        ...
        this.setState({
          frequency_list: this.state.frequency_list.concat(
  ...
  render() {
    ...
    AdminCrewLeadAttendanceLog =
      this.props.route.params.AdminCrewLeadAttendanceLog;
    return (
      <View style={{flex: 1}}>
...
export default CrewLeadAttendanceLog;
